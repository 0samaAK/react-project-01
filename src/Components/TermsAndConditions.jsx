  ...
  return (
    <>
      <section id="termsandcond">
        <header>TERMS AND CONDITONS</header>
        <h5>LXURY HOTELS</h5>
        <p>
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptas
          corporis vero ullam eaque dignissimos perspiciatis inventore at amet
          ad illo officiis quasi doloribus, obcaecati fuga, necessitatibus quam
          dolores! Autem, velit!
        </p>
